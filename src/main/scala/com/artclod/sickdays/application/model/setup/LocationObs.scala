...
//class LocationObs(nameValue : String = "Location", numberValue : Int = 10, employeeConstitutionValue : Int = 10) {
class LocationObs(data : LocationData = new LocationData) {
	...
	def toData = LocationData(name.get, numberEmployees.get, employeeConstitution.get)
}
